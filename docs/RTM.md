...
> **覆蓋率說明**：「TC 規劃覆蓋 %」= AC 有對應 TC-ID 規劃（即使 BDD Scenario 尚未撰寫）；
> 「BDD Scenario 覆蓋 %」= AC 有對應實際存在的 BDD Scenario 文件。兩者不同——前者反映規劃完整度，後者反映可自動化執行的測試完整度。

| US | AC 數 | TC 數（§15.1）| TC 規劃覆蓋 % | BDD Scenario 覆蓋 % | 待補 BDD |
|----|-------|--------------|:------------:|:------------------:|---------|
| US-ACCT-001 | 5 | 7 | 100% | ~80% | AC-4 鎖定邊界 Scenario |
| US-ROOM-001 | 7 | 8 | 100% | ~57% | AC-3 Bot E2E、AC-4 WS 重連失敗、AC-6 Circuit Breaker |
| US-FISH-001 | 6 | 6 | 100% | ~33% | AC-2 RTP 金幣、AC-3 Boss 安慰獎、AC-4 Boss 動畫、AC-5 降級 |
| US-WPSK-001 | 4 | 4 | 100% | ~75% | AC-2 冰凍技能 E2E Smoke |
| US-RTP-001 | 5 | 6 | 100% | ~60% | AC-2 連敗補償、AC-5 RTP Health Check 降級 |
| US-SHOP-001 | 6 | 7 | 100% | ~67% | AC-2 鑽石不足拒絕購買、AC-4 金幣倍率扣減邊界 |
| US-AGE-001 | 3 | 4 | 100% | ~67% | AC-1 DEMO_ONLY 中間狀態 |
| **P0 小計** | **36** | **42** | **100%** | **~61%** | 13 個 AC 待補 BDD Scenario |
| US-VIP-001（P1）| 3 | 3 | 100% | ~100% | — |
| **Total** | **39** | **45** | **100%** | **~67%** | 見上表各 US 待補欄 |
