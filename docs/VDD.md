...
| color-bg-overlay | rgba(5,20,40,0.85) | color-ocean-900 @ 85% opacity | 模態遮罩 |
...
| 類型 | 背景 | 邊框 | 圓角 | 陰影 |
|------|------|------|------|------|
| 標準面板 | rgba(10,35,64,0.95) | 1px solid rgba(245,200,66,0.3) | `--radius-lg`（24px） | 0 8px 32px rgba(0,0,0,0.6) |
...
--color-gold-border-subtle: rgba(245,200,66,0.3);   /* color-gold-400 @ 30%；HUD/卡片玻璃面板邊框主題色（多個元件共用） */
...
/* ── HUD ── */
--hud-bg:                  rgba(10,35,64,0.8);    /* color-ocean-900 @ 80%，無匹配 primitive，直接值 */
--hud-border:              var(--color-gold-border-subtle);   /* color-gold-400 @ 30% */
...
/* ── Jackpot Bar ── */
--jackpot-bar-bg:          rgba(10,35,64,0.9);    /* color-ocean-900 @ 90%，無匹配 primitive，直接值 */
...
/* ── Card / Panel ── */
--card-bg:                 rgba(10,35,64,0.95);   /* color-ocean-900 @ 95%，無匹配 primitive，直接值 */
--card-border:             var(--color-gold-border-subtle);   /* color-gold-400 @ 30% */
