...
| color-text-disabled | rgba(255,255,255,0.35) | composited #5C6673 | 禁用文字（WCAG 1.4.3 豁免） |
...
**尺寸**：高度 56 px，水平 Padding 24 px，圓角 `--radius-md`（16 px），最小寬度 160 px
...
**尺寸**：高度 48 px，水平 Padding 20 px，圓角 `--radius-md`（16 px）
...
**尺寸**：高度 48 px，水平 Padding 20 px，圓角 `--radius-md`（16px）
