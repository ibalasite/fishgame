...
| 狀態 | 背景 | 邊框 | 文字色 | 提示文字色 |
|------|------|------|-------|----------|
| Default | `var(--input-bg)` (rgba(255,255,255,0.05)) | 1px solid `color-border-default`（rgba(255,255,255,0.45)） | `var(--color-text-primary)` | `var(--input-placeholder)` (rgba(255,255,255,0.4)) |
| Hover | `var(--input-bg-hover)` (rgba(255,255,255,0.07)) | 1px solid `color-border-strong`（rgba(255,255,255,0.7)） | `var(--color-text-primary)` | `var(--input-placeholder)` |
| Focus | `var(--input-bg-focus)` (rgba(255,255,255,0.08)) | 2px solid `color-border-focus`（#F5C842）| `var(--color-text-primary)` | — |
| Error | `var(--input-bg-error)` | 2px solid `color-border-error`（#FF4444） | `var(--color-text-primary)` | — |
| Disabled | `var(--input-bg-disabled)` | 1px solid `color-border-subtle`（rgba(255,255,255,0.2)） | `color-text-disabled`（rgba(255,255,255,0.35)） | — |
...
/* ── Button — Icon ── */
--icon-btn-bg-hover:  rgba(255,255,255,0.08);  /* white @ 8%，無匹配 primitive，直接值 */
...
| Boss 死亡 / Jackpot | 觸發 | ≥3000ms | 200+ 金幣+光柱 | `var(--color-action-primary)` + #FFD700 + `var(--color-text-primary)` |
